/*
g++ -std=c++23 -Wall -Wextra 04.10.cpp -o 04.10.out
./04.10.out
*/
...
//  ------------------------------------------------------------------------------------------
    ...
    static_assert(has_v<Deque<int>, Deque<Deque<int>, double>> == true);
    ...
    static_assert(has_v<int, Deque<int, int, double>> == true);
}
